...
File     : modules/02_eigrp_netmiko/utils/check_ssh.py
...
def main():
    parser = argparse.ArgumentParser(description="Check SSH connectivity to NAMS26 lab hosts.")
    parser.add_argument("--host", help="Check a single host by name (R1) or DNS name (r1.lab).")
    args = parser.parse_args()

    print(f"\n{CYAN}{BOLD}{'─'*65}")
    print("  NAMS26 — SSH Connectivity Check")
