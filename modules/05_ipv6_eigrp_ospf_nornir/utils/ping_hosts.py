...
File     : modules/05_ipv6_eigrp_ospf_nornir/utils/ping_hosts.py
...
def main():
    parser = argparse.ArgumentParser(description="Ping NAMS26 Module 05 lab hosts.")
    ...
    print(f"\n{CYAN}{BOLD}{'─' * 55}")
    print("  NAMS26 — Module 05: Ping Hosts Utility")
    print(f"{'─' * 55}{RESET}\n")
