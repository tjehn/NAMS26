...
# File     : modules/05_ipv6_eigrp_ospf_nornir/utils/clear_known_hosts.sh
...
# -----------------------------------------------------------------------------
# Lab node inventory — R1 through R9 (Module 05 has 9 routers)
...
echo -e "${CYAN}${BOLD}  NAMS26 — Module 05: Clear Known Hosts${RESET}"
