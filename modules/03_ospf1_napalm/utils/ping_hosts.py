...
File     : modules/03_ospf1_napalm/utils/ping_hosts.py
...
def main():
    parser = argparse.ArgumentParser(description="Ping NAMS26 Module 03 lab hosts.")
    ...
    print(f"\n{CYAN}{BOLD}{'─' * 55}")
    print("  NAMS26 — Module 03: Ping Hosts Utility")
    print(f"{'─' * 55}{RESET}\n")
